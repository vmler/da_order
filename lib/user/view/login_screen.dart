            ...
            child: Column(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () async {
                    const refreshToken =
                        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InRlc3RAY29kZWZhY3RvcnkuYWkiLCJzdWIiOiJmNTViMzJkMi00ZDY4LTRjMWUtYTNjYS1kYTlkN2QwZDkyZTUiLCJ0eXBlIjoicmVmcmVzaCIsImlhdCI6MTcwODMwNTM3NSwiZXhwIjoxNzA4MzkxNzc1fQ.okWv6TtOPea5BxZilO2yzJ4CN9rQZjLycy9-Cxiek4o';
                    final response = await dio.post(
                      "http://$ip/auth/token",
                      options: Options(headers: {
